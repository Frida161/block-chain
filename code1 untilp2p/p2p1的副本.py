        ...
        while True:
            ...
            try:
                ...
                if message[0:1] == b'\x11' :
                    ...
                    #print("from" + address[0] + '：' + client.recv(512).decode('utf-8'))
                elif message[0:1] == b'1':
                    receive_block(message[1:].decode('utf-8'))
                    print(CTcoin.chain)
                elif message[0:1] == b'2':
                    receive_transaction(message[1:].decode('utf-8'))
                    self._my_queue.put('Someone has initiated a new transaction and the transaction pool has been updated')
    ...
    while True:
        ...
        if is_start:
            ...
            if order == '1':
                ...
                client_thread.send_message((address[0],1234), b'3' + bytes('someone has mined successfully','utf-8'))
            elif order == '2' :
